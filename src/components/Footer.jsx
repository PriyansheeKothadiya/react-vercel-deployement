...
export default function Footer() {
  ...
  return (
    <footer className="relative footer-bg text-gray-800 dark:text-gray-300 pt-16 pb-8 overflow-hidden">
      {/* Glow blobs */}
      ...
      <div className="container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-700 mt-3">AI workspace that helps teams automate repetitive work and focus on outcomes.</p>
            <div className="mt-4 flex gap-3">
              <motion.a whileHover={{ scale: 1.08 }} className="p-2 rounded-full bg-white/5 hover:bg-white/8" href="#"><FaLinkedin className="text-xl text-gray-700 dark:text-gray-300" /></motion.a>
              <motion.a whileHover={{ scale: 1.08 }} className="p-2 rounded-full bg-white/5 hover:bg-white/8" href="#"><FaGithub className="text-xl text-gray-700 dark:text-gray-300" /></motion.a>
              <motion.a whileHover={{ scale: 1.08 }} className="p-2 rounded-full bg-white/5 hover:bg-white/8" href="#"><FaTwitter className="text-xl text-gray-700 dark:text-gray-300" /></motion.a>
              <motion.a whileHover={{ scale: 1.08 }} className="p-2 rounded-full bg-white/5 hover:bg-white/8" href="#"><FaInstagram className="text-xl text-gray-700 dark:text-gray-300" /></motion.a>
            </div>
          </div>

          <div>
            <div className="font-semibold mb-3 text-gray-700">Product</div>
          ...
          <div>
            <div className="font-semibold mb-3 text-gray-700">Resources</div>
            <nav className="space-y-1">
          ...
          <div>
            <div className="font-semibold mb-3 text-gray-700">Newsletter</div>
            <div className="glass p-4 rounded-2xl">
              ...
              <form onSubmit={(e)=>e.preventDefault()} className="mt-3 flex gap-2">
                ...
                <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-blue-400 subscribe-text">Subscribe</button>
              </form>
            </div>
          </div>
        </motion.div>
